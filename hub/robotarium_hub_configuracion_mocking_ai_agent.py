...
class RobotariumHub:
    def __init__(self):
        ...
        # Escuchar en todas las interfaces disponibles en el puerto 5555
        self.commands_socket.bind(f'tcp://*:{CMD_PORT}')
        
        self.data_socket = self.context.socket(zmq.PUB)
        
        # Escuchar en todas las interfaces disponibles en el puerto 5556
            ...
            for a in self.agents:
                ...
                if s in socks and socks[s] == zmq.POLLIN:
                    try:
                        ...
                        logging.error(f'Agent {a} sent invalid JSON')
